...
//: This API lets you search iTunes for songs,
...
struct Track {
	...
	func displayTrack(){
		print("Track Name:\(name) by: \(artist) Preview URL:\n\(previewURL.description)\n")
	}
	...
	func updateSearchResults(_ data: Data) {
		...
		for trackDictionary in array {
			if let trackDictionary = trackDictionary as? JSONDictionary,
				...
				let track = Track(name: name, artist: artist, previewURL: previewURL)
					tracks.append(track)
